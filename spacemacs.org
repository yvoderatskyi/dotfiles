...
* Spacemacs configuration
  I prefer to use literate programming style of dotfiles
    ...
    values."
      (setq-default
       ...
       '(
         ...
         plantuml
         (plantuml :variables
              org-plantuml-jar-path "/usr/local/Cellar/plantuml/1.2020.11/libexec/plantuml.jar"
              plantuml-jar-path "/usr/local/Cellar/plantuml/1.2020.11/libexec/plantuml.jar"
